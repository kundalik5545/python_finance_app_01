...
# Add keywords to category json file
...
def main():
    st.title("Sample finance dashboard")

    uploaded_file = st.file_uploader("Upload your finance transaction as CSV file", type=["CSV"])
    ...
    if uploaded_file is not None:
        ...
        if df is not None:
            ...
            with tab1:
                ...
                fig = px.pie(category_totals, names="Category", values="Amount", title="Expense Distribution by Category")
